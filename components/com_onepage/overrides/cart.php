...
// 				continue;
	 ...
	 */
	 function getProduct($virtuemart_product_id) {
	...
	*/
	 ...
	 */
	 function validateUserData($type='BT', $obj = null) {
...
// 		vmdebug('sentOrderConfirmedEmail my order',$order);
	...
	public function prepareCartData($checkAutomaticSelected=true){
		//echo $this->virtuemart_shipmentmethod_id; 
	...
	*/
	function prepareCartViewData(){
	 ...
	 function prepareCartPrice( $prices ){
