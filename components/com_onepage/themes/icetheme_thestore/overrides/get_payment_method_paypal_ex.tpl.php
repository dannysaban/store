...
echo '<br style="clear: both; padding-top: 10px;"/>';
...
$html = '<img onclick="javascript: return document.getElementById(\'paypalExpressID_ecm\').click();" id="paypalLogo" src="'.$paypal_buttonurls[$lang_iso].'" alt="PayPal Checkout Available" border="0" style="cursor:pointer;" />';
