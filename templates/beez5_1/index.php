    ...
    <header id="header">
      <?php endif; ?>
        <div class="logoheader">
		        ...
		        <img src="<?php echo $this->baseurl ?>/templates/<?php echo $this->template; ?>/images/about_edited-1.JPG"  alt="<?php echo JText::_('TPL_BEEZ5_LOGO'); ?>" />
				<img src="<?php echo $this->baseurl ?>/templates/<?php echo $this->template; ?>/images/brownLong.JPG"  alt="<?php echo JText::_('TPL_BEEZ5_LOGO'); ?>" />
          <!--<h1 id="logo">-->
    ...
    <?php if ($showbottom) : ?>
      <div id="footer-inner">
        ...
        <div id="bottom">
          ...
          <div class="box box3"> <jdoc:include type="modules" name="position-9" style="beezDivision" headerlevel="3" /></div>
          <?php endif; ?>
             <?php if ($this->countModules('position-10')): ?>
          <div class="box box3"> <jdoc:include type="modules" name="position-10" style="beezDivision" headerlevel="3" /></div>
          <?php endif; ?>
